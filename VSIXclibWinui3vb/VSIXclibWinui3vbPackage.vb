...
<Guid(VSIXclibWinui3vbPackage.PackageGuidString)>
Public NotInheritable Class VSIXclibWinui3vbPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "53e8981c-ee7b-47d9-8e6f-1fcb0623c21a"
