...
namespace p
{
    public partial class PkApplication : Windows.UI.Xaml.Application
    {
...
#region "Settingsy jako Extension"
    ...
    public static void GetSettingsString(this Windows.UI.Xaml.Controls.TextBlock oItem, string sName = "", string sDefault = "")
    {
    ...
    public static void SetSettingsString(this Windows.UI.Xaml.Controls.TextBlock oItem, string sName = "", bool bRoam = false)
    {
        if (sName == "") sName = oItem.Name;
...
public static void GetSettingsString(this Windows.UI.Xaml.Controls.TextBox oItem, string sName = "", string sDefault = "")
{
    if (sName == "") sName = oItem.Name;
        string sTxt = vb14.GetSettingsString(sName, sDefault);
        oItem.Text = sTxt;
...
public static void SetSettingsString(this Windows.UI.Xaml.Controls.TextBox oItem, string sName = "", bool bRoam = false) 
{        if(sName == "") sName = oItem.Name;
        vb14.SetSettingsString(sName, oItem.Text, bRoam);
    }


public static void GetSettingsBool(this Windows.UI.Xaml.Controls.ToggleSwitch oItem, string sName = "", bool bDefault = false)
{
    if (sName == "") sName = oItem.Name;
...
public static void SetSettingsBool(this Windows.UI.Xaml.Controls.ToggleSwitch oItem, string sName = "", bool bRoam = false)
{
    if (sName == "") sName = oItem.Name;
...
public static void GetSettingsBool(this Windows.UI.Xaml.Controls.Primitives.ToggleButton oItem, string sName = "", bool bDefault = false)
{
    if (sName == "") sName = oItem.Name;
        bool bBool = vb14.GetSettingsBool(sName, bDefault);
...
public static void SetSettingsBool(this Windows.UI.Xaml.Controls.Primitives.ToggleButton oItem, string sName = "", bool bRoam = false)
{
    if (sName == "") sName = oItem.Name;
...
public static void GetSettingsBool(this Windows.UI.Xaml.Controls.AppBarToggleButton oItem, string sName = "", bool bDefault = false)
{
    if (sName == "") sName = oItem.Name;
        bool bBool = vb14.GetSettingsBool(sName, bDefault);
        oItem.IsChecked = bBool;
    ...
    public static void SetSettingsBool(this Windows.UI.Xaml.Controls.AppBarToggleButton oItem, string sName = "", bool bRoam = false)
    {
        if (sName == "") sName = oItem.Name;
        vb14.SetSettingsBool(sName, oItem.IsChecked ?? false, bRoam);
    }

    public static void SetSettingsInt(this Windows.UI.Xaml.Controls.Slider oItem, string sName = "", bool bRoam = false)
    {
        if (sName == "") sName = oItem.Name;
        vb14.SetSettingsInt(sName, (int)oItem.Value, bRoam);
    }

    public static void GetSettingsInt(this Windows.UI.Xaml.Controls.Slider oItem, string sName = "", double defVal = 5)
    {
        if (sName == "") sName = oItem.Name;
    ...
    public static async void ShowAppVers(this Windows.UI.Xaml.Controls.TextBlock oItem)
    {
    ...
    public static void ShowAppVers(this Windows.UI.Xaml.Controls.Page oPage)
    {
        Windows.UI.Xaml.Controls.Grid oGrid = (Windows.UI.Xaml.Controls.Grid)oPage.Content;
        if(oGrid is null)
            {
        ...
        Windows.UI.Xaml.Controls.TextBlock oTB = new Windows.UI.Xaml.Controls.TextBlock
        {
        ...
        if (iRows > 2) Windows.UI.Xaml.Controls.Grid.SetRow(oTB, 1);
        if (iCols > 1)
        {
...
#pragma warning restore IDE0019 // Use pattern matching
        ...
        {
            Windows.UI.Xaml.Controls.ProgressRing _mProgRing = new Windows.UI.Xaml.Controls.ProgressRing
            {
